...
class SnippetsControllerTest < ActionController::TestCase
  ...
  test "should create snippet" do
    assert_difference('Snippet.count') do
      post :create, snippet: { css: @snippet.css, description: @snippet.description, html: @snippet.html, name: @snippet.name }
    end
  ...
  test "should update snippet" do
    put :update, id: @snippet, snippet: { css: @snippet.css, description: @snippet.description, html: @snippet.html, name: @snippet.name }
    assert_redirected_to snippet_path(assigns(:snippet))
  end
